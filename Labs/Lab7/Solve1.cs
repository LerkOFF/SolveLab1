namespace SolveLabs.Labs.Lab7
{
    ...
    public static class Solve1
    {
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    default:
                        ...
                        Console.WriteLine("Некорректный выбор. Пожалуйста, выберите пункт от 1 до 8.");
                        Console.ResetColor();
                        break;
                }
        ...
        private static void DisplayMenu()
        {
            ...
            Console.WriteLine("8 – Сортировка по населению (Population)");
            Console.WriteLine();
        }
        ...
        /// </summary>
        /// <param name="actionType">Тип действия (ADD, DELETE, UPDATE, SORT)</param>
        ...
        /// <summary>
        /// Сортировка списка стран по населению с использованием сортировки выбором
        /// </summary>
        private static void SortByPopulation()
        {
            ...
            {
                Console.ForegroundColor = ConsoleColor.Yellow;
                Console.WriteLine("Недостаточно записей для сортировки.");
                Console.ResetColor();
                return;
            }
            ...
            AddLog("SORT", new Country { Name = "Сортировка по населению" });

            SaveTableToFile(); // Сохранение отсортированной таблицы

            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("Таблица успешно отсортирована по населению (Population) с использованием сортировки выбором.");
            Console.ResetColor();
        }
    }
}
